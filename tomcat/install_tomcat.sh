...
sed -i "1iexport JAVA_HOME=/usr/local/java/jdk1.8.0_144" /home/websoft/apache-tomcat-8.5.34/bin/catalina.sh
sed -i "2iexport JRE_HOME=/usr/local/java/jdk1.8.0_144/jre" /home/websoft/apache-tomcat-8.5.34/bin/catalina.sh
